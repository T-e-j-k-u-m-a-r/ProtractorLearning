    ...
    quitDriver(driver) {
        ...
        if (driver.getSession() === undefined) {
            ...
            return driver.getSession()
                .then((session_) => {
                if (session_) {
                    //Note: The below commented code closed the browser after completion of every describe block
                    return driver.quit();

                    //Note: The below command will not close the browser after completion of every describe block
                    //return 0;
                }
            })
                .catch(function (err) { });
